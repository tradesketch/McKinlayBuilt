    ...
    callback({
      responseHeaders: {
        ...
        'Content-Security-Policy': [
          "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: blob:; connect-src 'self' https://mckinlaybuilt-production.up.railway.app http://localhost:3141 https://api.openweathermap.org wss: ws:; font-src 'self' data: https://fonts.gstatic.com; media-src 'self' blob:;"
        ]
      }
    });
  });
